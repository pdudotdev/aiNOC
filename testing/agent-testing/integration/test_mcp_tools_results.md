...
*Generated: 2026-03-02 17:35:00 UTC*
            ...
            "1": {
              "ospfNeighborEntries": [
                ...
                },
                {
                  ...
                  "inactivity": 1772472927.5686033,
                  "details": {
                    "areaId": "0.0.0.0",
                    "designatedRouter": "0.0.0.0",
                    "backupDesignatedRouter": "0.0.0.0",
                    "numberOfStateChanges": 7,
                    "stateTime": 1772446061.5686169,
                    "inactivityDefers": 0,
                ...
                },
                {
                  ...
                  "inactivity": 1772472925.5687802,
                  "details": {
                    "areaId": "0.0.0.2",
                    "designatedRouter": "0.0.0.0",
                    "backupDesignatedRouter": "0.0.0.0",
                    "numberOfStateChanges": 7,
                    "stateTime": 1772446064.568793,
                    "inactivityDefers": 0,
                ...
                },
                {
                  ...
                  "inactivity": 1772472925.569022,
                  "details": {
                    "areaId": "0.0.0.2",
                    "designatedRouter": "0.0.0.0",
                    "backupDesignatedRouter": "0.0.0.0",
                    "numberOfStateChanges": 7,
                    "stateTime": 1772446060.569031,
                    "inactivityDefers": 0,
  ...
  "parsed": [
    {
      ...
      "fp-tx-byte": "0",
      "fp-tx-packet": "0",
      "last-link-up-time": "2026-03-02 10:07:12",
      "link-downs": "0",
    ...
    },
    {
      ...
      "fp-tx-byte": "0",
      "fp-tx-packet": "0",
      "last-link-up-time": "2026-03-02 10:07:03",
      "link-downs": "0",
    ...
    },
    {
      ...
      "fp-tx-packet": "0",
      "l2mtu": "65535",
      "last-link-up-time": "2026-03-02 10:07:19",
      "link-downs": "0",
...
```json
{
  ...
  "parsed": [
    {
      "messages": [
        "PING 10.1.1.5 (10.1.1.5) 72(100) bytes of data.\n80 bytes from 10.1.1.5: icmp_seq=1 ttl=255 time=0.366 ms\n80 bytes from 10.1.1.5: icmp_seq=2 ttl=255 time=0.246 ms\n80 bytes from 10.1.1.5: icmp_seq=3 ttl=255 time=0.269 ms\n80 bytes from 10.1.1.5: icmp_seq=4 ttl=255 time=0.240 ms\n80 bytes from 10.1.1.5: icmp_seq=5 ttl=255 time=0.258 ms\n\n--- 10.1.1.5 ping statistics ---\n5 packets transmitted, 5 received, 0% packet loss, time 1ms\nrtt min/avg/max/mdev = 0.240/0.275/0.366/0.046 ms, ipg/ewma 0.349/0.319 ms\n"
      ]
    }
  ]
}
...
```json
{
  ...
  "parsed": [
    ...
    },
    {
      ...
      "fp-tx-packet": "0",
      "l2mtu": "65535",
      "last-link-up-time": "2026-03-02 17:35:00",
      "link-downs": "0",
      "mac-address": "36:81:58:D0:AA:9B",
      "mtu": "auto",
      "name": "Loopback99",
...
```json
{
  ...
  "rollback_advisory": [
    "# RouterOS DELETE rollback requires manual action: /rest/interface/bridge/*12"
  ]
}
```
